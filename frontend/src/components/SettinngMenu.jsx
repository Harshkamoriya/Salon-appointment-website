 ...
 console.log(selectedButton)
  ...
  return (
    <StyledAdminBox>
      ...
      <QuickActions>
  <button onClick={() => handleButton('button1')}> Edit profile </button>
  <button onClick={() => handleButton('button2')}> change password</button>
  <button onClick={() => handleButton('button3')}> notification </button>
  <button onClick={() => handleButton('button4')}> Booking history</button>
  <button onClick={() => handleButton('button5')}> Payment history</button>
